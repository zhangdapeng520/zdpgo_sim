...
import "github.com/zhangdapeng520/zdpgo_sim/edlib/internal/utils"

// LevenshteinDistance 此算法允许插入、删除和替换将一个字符串更改为第二个兼容非ascii字符
...
// OSADamerauLevenshteinDistance 计算两个弦之间的距离
// 扩展了Wagner-Fisher动态规划算法的最优字符串对齐距离变体
// 不允许在同一子字符串上进行多个转换
// 允许插入、删除、替换和换位来将一个字符串变为第二个字符串
